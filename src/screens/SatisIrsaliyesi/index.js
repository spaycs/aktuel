...
import SatisIrsaliyesiBilgisi from '../../screens/SatisIrsaliyesiBilgisi';
import SatisIrsaliyesiUrunList from '../../screens/SatisIrsaliyesiUrunList';
import SatisIrsaliyesiOnizleme from '../../screens/SatisIrsaliyesiOnizleme';
import SatisIrsaliyesiDetay from '../../screens/SatisIrsaliyesiDetay';
...
const SatisIrsaliyesi = ({navigation, route}) => {
  const { Id } = useAuth();
  ...
  const [routes, setRoutes] = useState([
    ...
    { key: 'detay', title: 'Detay', icon: Bilgi },
  ...
  const renderScene = SceneMap({
    faturaBilgisi: SatisIrsaliyesiBilgisi,
    detay: SatisIrsaliyesiDetay,
    urunList: SatisIrsaliyesiUrunList,
    onizleme: SatisIrsaliyesiOnizleme,
  });
...
export default SatisIrsaliyesi;
