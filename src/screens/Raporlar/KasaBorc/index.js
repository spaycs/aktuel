...
const KasaBorc = () => {
  ...
  const fetchData = async () => {
    ...
    setError('');
    try {
      const response = await axiosLinkMain.get(`/Api/Raporlar/KasaRaporuBorc?ilktarih=${formatDateForApi(startDate)}&sontarih=${formatDateForApi(endDate)}`);
