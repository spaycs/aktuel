...
const SorumlulukBazindaBekleyenSiparis = () => {
   ...
   useEffect(() => {
     ...
     const logHareket = async () => {
       ...
       try {
         ...
         const body = {
           Message: 'Sorumluluk Bazında Bekleyen Sipariş Rapor Açıldı', // Hardcoded message
           User: defaults[0].IQ_MikroPersKod, // Temsilci ID
           database: defaults[0].IQ_Database, // Database ID
           data: 'Sorumluluk Bazında Bekleyen Sipariş Rapor' // Hardcoded data
         };
