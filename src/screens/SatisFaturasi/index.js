...
import SatisFaturasiFaturaBilgisi from '../../screens/SatisFaturasiFaturaBilgisi';
import SatisFaturasiUrunList from '../../screens/SatisFaturasiUrunList';
import SatisFaturasiOnizleme from '../../screens/SatisFaturasiOnizleme';
...
const SatisFaturasi = ({navigation}) => {
  const { Id } = useAuth();
  ...
  const renderScene = SceneMap({
    faturaBilgisi: SatisFaturasiFaturaBilgisi,
    urunList: SatisFaturasiUrunList,
    onizleme: SatisFaturasiOnizleme,
  });
  ...
  const validateFields = () => {
    if (!faturaBilgileri.cha_kod || !faturaBilgileri.cha_cari_unvan1) {
      Alert.alert(
        "Uyarı",
      ...
      return false;
    } else if (!faturaBilgileri.cha_adres_no) {
      Alert.alert(
        "Uyarı",
