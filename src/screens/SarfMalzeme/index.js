...
import SarfMalzemeBilgi from '../../screens/SarfMalzemeBilgi';
import SarfMalzemeUrunList from '../../screens/SarfMalzemeUrunList';
...
const SarfMalzeme = ({navigation}) => {
  ...
  const renderScene = SceneMap({
    faturaBilgisi: SarfMalzemeBilgi,
    urunList: SarfMalzemeUrunList,
    onizleme: SarfMalzemeOnizleme,
  });
