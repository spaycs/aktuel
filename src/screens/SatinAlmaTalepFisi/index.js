...
import SatinAlmaTalepFisiBilgi from '../../screens/SatinAlmaTalepFisiBilgi';
import SatinAlmaTalepFisiUrunList from '../../screens/SatinAlmaTalepFisiUrunList';
import SatinAlmaTalepFisiOnizleme from '../../screens/SatinAlmaTalepFisiOnizleme';
...
const SatinAlmaTalepFisi = ({navigation}) => {
  ...
  const renderScene = SceneMap({
    faturaBilgisi: SatinAlmaTalepFisiBilgi,
    urunList: SatinAlmaTalepFisiUrunList,
    onizleme: SatinAlmaTalepFisiOnizleme,
  });
  ...
  const validateFields = () => {
    if (!faturaBilgileri.kaynakDepo ) {
      Alert.alert(
        "Uyarı",
        "Depo seçmeden işleme devam edemezsiniz.",
        [{ text: "Tamam" }]
      );
      return false;
    }
