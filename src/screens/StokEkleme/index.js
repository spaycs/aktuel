...
import StokEklemeBilgisi from '../../screens/StokEklemeBilgisi';
import StokEklemeFiyat from '../../screens/StokEklemeFiyat';
import StokEklemeOnizleme from '../../screens/StokEklemeOnizleme';
import StokEklemeDetay from '../../screens/StokEklemeDetay';
...
const StokEkleme = ({navigation}) => {
  ...
  const [routes] = useState([
    ...
    { key: 'detay', title: 'Barkod', icon: Liste  },
    { key: 'urunList', title: 'Fiyat', icon: Liste },
    { key: 'onizleme', title: 'Önizleme', icon: Onizleme },
  ]);

  const renderScene = SceneMap({
    faturaBilgisi: StokEklemeBilgisi,
    detay: StokEklemeDetay,
    urunList: StokEklemeFiyat,
    onizleme: StokEklemeOnizleme,
  });
