...
import TahsilatTediyeBilgisi from '../../screens/TahsilatTediyeBilgisi';
import TahsilatTediyeDetay from '../../screens/TahsilatTediyeDetay';
...
const TahsilatTediye = ({navigation}) => {
  ...
  const [routes, setRoutes] = useState([
    ...
    { key: 'urunList', title: 'Detay', icon: Liste },
  ...
  const renderScene = SceneMap({
    faturaBilgisi: TahsilatTediyeBilgisi,
    urunList: TahsilatTediyeDetay,
    onizleme: TahsilatTediyeOnizleme,
  });
