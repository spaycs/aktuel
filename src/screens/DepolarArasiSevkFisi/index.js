...
import DepolarArasiSevkFisiBilgisi from '../../screens/DepolarArasiSevkFisiBilgisi';
import DepolarArasiSevkFisiUrunList from '../../screens/DepolarArasiSevkFisiUrunList';
...
const DepolarArasiSevkFisi = ({navigation}) => {
  ...
  const renderScene = SceneMap({
    faturaBilgisi: DepolarArasiSevkFisiBilgisi,
    urunList: DepolarArasiSevkFisiUrunList,
    onizleme: DepolarArasiSevkFisiOnizleme,
  });

  const validateFields = () => {
    if (!faturaBilgileri.kaynakDepo) {
      Alert.alert(
        "Uyarı",
        "Kaynak depo seçmelisiniz.",
        [{ text: "Tamam" }]
      );
      return false;
    } else if (!faturaBilgileri.hedefDepo) {
      Alert.alert(
        "Uyarı",
...
export default DepolarArasiSevkFisi;
