        ...
        evraklar: [
          {
            ...
            satirlar: productsWithCalculatedValues.map((product) => ({
              tkl_evrak_tarihi: faturaBilgileri.sth_tarih,
              tkl_evrakno_seri: faturaBilgileri.sth_evrakno_seri,
              tkl_belge_no: 0,
              tkl_cari_kod: faturaBilgileri.sth_cari_kodu,
              tkl_harekettipi: 10,
              tkl_stok_kod: product.Stok_Kod,
              tkl_Aciklama: product.aciklama,
              tkl_Alisfiyati: product.sth_tutar, 
              tkl_baslangic_tarihi: faturaBilgileri.sth_bas_tarih,
              tkl_belge_tarih: faturaBilgileri.sth_bas_tarih,
              tkl_Gecerlilik_Sures: faturaBilgileri.sth_gec_tarih,
              tkl_miktar: product.sth_miktar,
              tkl_birim_pntr: product.sth_birim_pntr,
              tkl_vergi_pntr: product.sth_vergi_pntr,
              tkl_cari_tipi: faturaBilgileri.sth_cari_cinsi,
              tkl_karorani: 0,
              tkl_ProjeKodu: faturaBilgileri.sth_proje_kodu,
              tkl_cari_sormerk: faturaBilgileri.sth_stok_srm_merkezi,
              tkl_stok_sormerk: faturaBilgileri.sth_stok_srm_merkezi,
              tkl_adres_no: faturaBilgileri.sth_adres_no,
              tkl_doviz_cins: faturaBilgileri.sth_har_doviz_cinsi,
              tkl_Brut_fiyat: product.total,
              tkl_iskonto1: product.sth_iskonto1,
              tkl_iskonto2: product.sth_iskonto2,
              tkl_iskonto3: product.sth_iskonto3,
              tkl_iskonto4: product.sth_iskonto4,
              tkl_iskonto5: product.sth_iskonto5,
              tkl_iskonto6: product.sth_iskonto6,
              tkl_Odeme_Plani: faturaBilgileri.sth_odeme_op,
            })),
          },
        ],
      },
            ...
            [
                {
                    ...
                    const logHareket = async () => {
                      ...
                      const body = {
                        Message: `Teklif Fişi Kaydedildi ${faturaBilgileri.sth_tarih} - ${faturaBilgileri.sth_evrakno_seri} - ${faturaBilgileri.sth_cari_kodu} - İşlem Yapılan Platform: ${platform}`,
...
{/* Sipariş Toplam Hesap */}
    ...
    {/* Apiye Giden Değerler 
        ...
        <Text style={MainStyles.faturaBilgileriText}>sth_bas_tarih: {faturaBilgileri.sth_bas_tarih}</Text>
        <Text style={MainStyles.faturaBilgileriText}>sth_gec_tarih: {faturaBilgileri.sth_gec_tarih}</Text>
        </View>
    {/* Apiye Giden Değerler */}
...
export default TeklifFisiOnizleme;
